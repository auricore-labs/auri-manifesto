...
2. (Optional) Custom domain:
   - Add `CNAME` file containing: `theauri.dev`
   - Point DNS `CNAME` of `www.theauri.dev` to `auricorelabs.github.io`.
3. Reserve social handles: `auri_method` on X/Twitter and a LinkedIn page. -->
